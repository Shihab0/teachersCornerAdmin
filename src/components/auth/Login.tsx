...
import { ShieldAlert, LogIn, Phone, ExternalLink, GraduationCap, Sparkles, Loader2, MapPin, School } from "lucide-react";
import { User as FirebaseUser } from "firebase/auth";

const KISHOREGANJ_AREAS = [
  "Harua", "Rathkhola", "Gaital", "Botrish", "Akhrakhabazar", 
  "Boro Bazar", "Nilganj", "Puran Thana", "Tarapasha", "Yashodal"
];
...
const KISHOREGANJ_INSTITUTIONS = [
  ...
  "President Abdul Hamid Medical College", "Shaheed Syed Nazrul Islam Medical College"
];
...
export const Login = ({ user, onLogin, onLogout }: LoginProps) => {
  ...
  return (
    <div 
      className="fixed inset-0 flex flex-col items-center justify-center bg-[#020617] overflow-hidden selection:bg-indigo-500/30 font-sans"
    ...
    >
      ...
      <div className="w-full max-w-sm z-10 px-6 mt-12">
        {/* Login Card */}
        <motion.div
              ...
              {user && user.email ? (
                ...
                >
                  ...
                  <motion.p variants={itemVariants} className="text-sm text-slate-400 mb-10 leading-relaxed font-medium">
                    কিশোরগঞ্জের অনলাইন টিউশন মিডিয়া। <br />
      ...
      <motion.p
        ...
        className="absolute bottom-6 text-[10px] text-slate-500 font-bold uppercase tracking-[4px] z-10"
      >
